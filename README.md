...
- Creating a new project
    ...
    - What is this `package.json`?
        - It is THE file that npm uses to do everything
        - TODO: add image of an example package.json
    - Dependencies: Allows us to add packages from other smart ppl
        ```
        npm install some-node-packages
        ```
    - Scripts: run cool bash scripts u write from the command line
